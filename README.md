...
Waste management and recycling require efficient identification and separation of different types of waste. This project explores the use of a Convolutional Neural Network to automatically classify waste images into six categories:
...
The dataset contains images belonging to six different waste categories.
...
Pixel values were normalized from the range:
...
Convolutional layers learn visual features from the images. The earlier layers learn simpler patterns such as edges and textures, while deeper layers learn more complex patterns.
...
The sample predictions contain both:

Correct predictions
Incorrect predictions

This provides a qualitative understanding of how the model performs beyond numerical evaluation metrics.
...
The model classifies waste images into six categories: cardboard, glass, metal, paper, plastic, and trash.
...
This project was developed as part of a Deep Learning learning portfolio.
